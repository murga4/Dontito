...
<div className="bg-[#1D1C1C] h-min grid grid-rows-1 grid-cols-2 sm:grid-cols-1 pt-4 ">
   ...
   <a className="p-2 border-2 rounded-full border-[#43E97B] hover:bg-white hover:text-black hover:border-white" href="mailto:ignaciomurgades@gmail.com">Contactar por Mail</a>
   </div>
</div>
</div>
    )
