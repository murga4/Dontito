...
<div className="flex gap-2 text-white sm:text-sm">
    <a className="text-[#1D1C1C] hover:bg-white hover:text-black font-medium bg-gradient-to-r from-[#43E97B] to-[#38F9D7] p-3 rounded-full"  href="#Trabajos">Ver Trabajos</a>
    <a className="border-white border-2 p-3 rounded-full hover:bg-white hover:text-black" href="#Contacto">Contacto</a>
</div>
</div>
