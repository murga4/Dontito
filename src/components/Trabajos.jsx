...
import Trabajo1 from "../assets/EIOU.png"
...
<div className=" flex h-min pb-10 sm:flex-col bg-[#1D1C1C] text-white sm:items-center pl-32 sm:pl-8 gap-16 sm:gap-6"> 
    ...
    <img className="w-64 h-48 rounded-xl" src= {Trabajo1} alt=""  />
        <h2 className="font-bold pt-7">Reebok App</h2>
        <p className="pb-6"> Diseño de producto </p>
        <a href="https://www.behance.net/gallery/227120389/Reebok-el-futuro-del-retail-Globant-DC" target="_blank" className="border-[#43E97B] border-2 p-3 pr-6 pl-6 rounded-full hover:bg-white hover:text-black hover:border-white">Ver trabajo</a>
    </div>
