...
<div className=" flex h-min pb-10 sm:flex-col bg-[#1D1C1C] text-white sm:items-center pl-32 sm:pl-8 gap-16 sm:gap-6"> 
    ...
    <img className="w-64 rounded-xl" src= {Trabajo1} alt=""  />
        ...
        <a href="https://nexus-ar.com/" target="_blank" className="border-[#43E97B] border-2 p-3 rounded-full hover:bg-white hover:text-black hover:border-white">Ver trabajo</a>
    </div>
    ...
    <img className="w-64 h-48 rounded-xl" src= {Trabajo2} alt=""  />
        ...
        <a href="https://www.behance.net/gallery/199729425/Registro-mas-facil-rapido-y-amigable-PAGO-FACIL" target="blank" className="border-[#43E97B] border-2 p-3 rounded-full hover:bg-white hover:text-black hover:border-white">Ver trabajo</a>
    </div>
    ...
    <img className="w-64 rounded-xl" src= {Trabajo3} alt=""  />
        ...
        <p className="pb-6"> Diseño UX/UI</p>
        <a href="https://www.behance.net/gallery/194756089/Eco-bici-Fomentando-el-transporte-sostenible" target="_blank" className="border-[#43E97B] border-2 p-3 rounded-full hover:bg-white hover:text-black hover:border-white">Ver trabajo</a>
    </div>
    ...
    <img className="w-64 rounded-xl h-48" src= {Trabajo4} alt=""  />
        ...
        <p className="pb-6"> Diseño · Desarrollo web </p>
        <a href="https://www.feriasdelcentrosrl.com/" target="_blank" className="border-[#43E97B] border-2 p-3 rounded-full hover:bg-white hover:text-black hover:border-white" >Ver trabajo</a>
    </div>
